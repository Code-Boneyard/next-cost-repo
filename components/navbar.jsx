      ...
      <nav className="flex items-center flex-wrap bg-gray-900 p-3 ">
        <Link legacyBehavior href="/">
          <a className="inline-flex items-center p-2 mr-4 ">
            ...
            <span className="text-xl text-white font-bold uppercase tracking-wide">LAYTON MEP</span>
          </a>
        </Link>
        ...
        <div className={`${active ? '' : 'hidden'}   w-full lg:inline-flex lg:flex-grow lg:w-auto`}>
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
            <Link className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-center hover:bg-green-600 hover:text-white" href="/sessions/login">
              Login
            </Link>
          </div>
        </div>
