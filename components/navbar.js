      ...
      <nav className="flex items-center flex-wrap bg-gray-900 text-white p-3 uppercase">
        <Link legacyBehavior href="/home">
          <a className="inline-flex items-center p-2  ">
            ...
            <span className="text-xl  tracking-wide">COST REPO</span>
          </a>
        </Link>
        ...
        <div className={`${active ? '' : 'hidden'}   w-full lg:inline-flex lg:flex-grow lg:w-auto`}>
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
            ...
            <Link className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center hover:bg-gray-100 hover:text-gray-700" href="/modeling">
              Compare
            </Link>
          </div>
        </div>
